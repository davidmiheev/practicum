...
- На вкладке Tasks теперь можно смотреть рейтинг заданий, составленный на основе отзывов студентов, а также топ сложных и лёгких заданий для рефакторинга (получены с помощью запроса из предыдущего задания)  
