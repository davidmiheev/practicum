...
- У каждого студента есть прогресс по курсу который имеет прирост (выражен в процентах, генерируется нормальным распределением) каждую неделю, в данных изменение прогресса в течение 4 недель

## Follow up

Что можно ещё джобавить в данные:
- [X] Оценки интересности заданий, указанные пользователями на платформе
- [] Может добавить в данные список менторов, ревьюеров и их контакты, а также как часто они взаимодействуют со студентами
